...
/*
Este script controla el comportamiento de las piezas en un juego de ajedrez en Unity.

- Selección de piezas: Permite seleccionar y deseleccionar piezas haciendo clic. Si se selecciona una pieza enemiga, intenta mover la pieza previamente seleccionada a esa posición.
- Movimiento de piezas: Gestiona el movimiento de las piezas con reglas específicas según su tipo (rey, peón, torre, etc.), incluyendo movimientos horizontales, verticales y diagonales, además de reglas especiales como el enroque y la promoción de peones.
- Validación de movimientos: Comprueba si un movimiento es legal (sin piezas bloqueando, válido según el tipo de pieza).
- Captura de piezas: Si una pieza se mueve a una casilla ocupada por un enemigo, se elimina la pieza enemiga.
- Estados de movimiento: Controla si una pieza está en movimiento e incluye eventos especiales como el doble paso de peones o el enroque.

El script interactúa con el GameController para manejar selecciones y turnos.
*/
